...
async function onSubmit() {
  ...
  if (keyMode.value === 'file') {
    ...
    await signFile(inputFile.value, privateKeyFile.value, undefined)
  } else {
    await signFile(inputFile.value, undefined, privateKeyText.value)
  }
}
...
<template>
  <main class="px-20 py-10">
    <h1 class="text-4xl font-bold">Лабораторна робота 5: DSS Підпис файлу</h1>
